						...
						<div class="find-place dfind-place">
							<div class="wrap">
								...
								<div class="p-ww">
									<form>
										<span> Where</span>
										<input class="dest" type="text" value="lorem ipsum" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Lorem ipsum';}">
										<span> When</span>
       	     ...
       	     <div class="container">
					<div class="blog">
						<div class="blog-grids">					
										...
										<div class="col-md-6">
											<div class="blog-grid">
												<div class="blog-poast-head">
													<div class="blog-art-pic">
														<a class="post-pic" href="#"> <img src="web/images/blog-pic.jpg" title="poast-name" /></a>
													</div>
													<div class="blog-poast-admin">
														<a href="#"><img src="web/images/admin-pic1.jpg" title="admin" /></a>
													</div>
										   ...
										   <div class="col-md-6">
												<div class="blog-grid">
													<div class="blog-poast-head">
														<div class="blog-art-pic">
															<a class="post-pic" href="#"> <img src="web/images/blog-pic1.jpg" title="poast-name" /></a>
														</div>
														<div class="blog-poast-admin">
															<a href="#"><img src="web/images/admin-pic2.jpg" title="admin" /></a>
														</div>
											 ...
											 <div class="row">
										        <div class="col-md-6">
													<div class="blog-grid">
														<div class="blog-poast-head">
															<div class="blog-art-pic">
																<a class="post-pic" href="#"> <img src="web/images/blog-pic2.jpg" title="poast-name" /></a>
															</div>
															<div class="blog-poast-admin">
																<a href="#"><img src="web/images/admin-pic3.jpg" title="admin" /></a>
															</div>
												...
												<div class="col-md-6">
													<div class="blog-grid">
														<div class="blog-poast-head">
															...
															<div class="blog-poast-admin">
																<a href="#"><img src="web/images/admin-pic4.jpg" title="admin" /></a>
															</div>
								...
								<div class="criuse-grid-load"><a href="#">Loading More</a></div>						
						</div>
					</div>
		<!----//End-Blog---->
           </div>
